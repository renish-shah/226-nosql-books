...
public class Main {
	...
	public static void main(String args[]) {
		...
		matrix = (HashMap<String, HashMap<String, FileDetails>>)parser.parse(f);
		...
		//matrix.get
		System.out.println("Book with high rank is : " + main.findBook("mimicry", matrix));
	...
	public String findBook(String keyword, HashMap<String, HashMap<String, FileDetails>> matrix)
	{
		String book=null;
		...
		for (Map.Entry<String,FileDetails> entry : fileDetails.entrySet())
		{
		    ...
		    if (maxEntry == null || a.compareTo(maxEntry.getValue().getStdev()) > 0)
		    {
		        maxEntry = entry;
		    }
		}
	...
	public void calculateStdDev(HashMap<String, HashMap<String, FileDetails>> matrix)
	{
		...
		{
		ArrayList<Integer> position = matrix.get(s).get(f).getPosition();
